...
public final class ShotResult {
    ...
    public static final class CellResult {
        ...
        public CellResult(Point point, boolean hit, Ship sunkShip, boolean mysteryCollected) {
            this.point = point;
            this.hit = hit;
    ...
    public ShotResult(String shooterId, String targetPlayerId, MissileType missile, Point target) {
    ...
    public void addCell(CellResult c) { cells.add(c); }
    public void addReward(MissileType t) { rewards.add(t); }
    public void incrementRewardsLost() { rewardsLost++; }
    public void setDirectHit(boolean v) { directHit = v; }
    public void setNewMysteryBox(Point p) { newMysteryBox = p; }
    public void setShooterInventory(Map<MissileType, Integer> m) { shooterInventory = m; }
    public void setNextTurnPlayerId(String id) { nextTurnPlayerId = id; }
